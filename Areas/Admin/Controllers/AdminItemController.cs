...
namespace Almocar2.Areas.Admin.Controllers
{
    ...
    public class AdminItemController : Controller
    {
        ...
        public AdminItemController(AppDbContext context, IWebHostEnvironment hostEnvironment, IOptions<ConfiguraImagem> confImg)
        {
            _context = context;
...
Imagemcurta)
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                {
                    ViewData["Erro"] = "não é possível deletar esse item porque ele está em execução";
                    return View();
                }
            }
            return RedirectToAction(nameof(Index));
